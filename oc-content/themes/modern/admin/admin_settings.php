    ...
    <div id="settings_form" style="border: 1px solid #ccc; background: #eee; ">
        <div style="padding: 20px;">
            ...
            <p style="border-bottom: 1px black solid;padding-bottom: 10px;">
                ...
                The preferred size of the logo is 600x100.
                <?php if(file_exists( WebThemes::newInstance()->getCurrentThemePath() . "images/logo.jpg" ) ) { ?>
                <strong>Note: There is a logo if you upload a logo image will be replaced.</strong>
                <?php } ?>
            </p>
            ...
            <form action="<?php echo osc_admin_render_theme_url('oc-content/themes/modern/admin/admin_settings.php');?>" method="post" enctype="multipart/form-data">
                ...
                <p>
                    <label for="package"><?php _e('Logo image'); ?> (png,gif,jpg)</label>
            ...
            <div>
                ...
                <?php } else { ?>
                    <p><?php _e('Has not uploaded any logo image');?></p>
                <?php } ?>
            </div>
            ...
            <div id="flash_message">
                <p>
                    <?php
                        $msg  = sprintf(__('The images folder %s is not writable on your server'), WebThemes::newInstance()->getCurrentThemePath() ."images/" ) .", ";
                        $msg .= __('OSClass can\'t upload logo image from the administration panel') . '. ';
                        $msg .= __('Please make the mentioned images folder writable') . '.';
                        echo $msg;
                    ?>
                </p>
                <p>
