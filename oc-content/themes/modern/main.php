                ...
                <div id="sidebar">
                    <div class="navigation">
                        ...
                        <div class="box location">
                            ...
                            <?php  View::newInstance()->_erase('list_regions'); while(osc_has_list_regions()){ ?>
...
<!--                                <li><a> <?php echo osc_field(osc_list_country(), 'country_name', '') ;?></a><em><?php echo osc_field(osc_list_country(), 'items', '') ;?></em></li>-->
                                <li><a> <?php echo osc_field(osc_list_region(), 'region_name', '') ;?></a><em><?php echo osc_field(osc_list_region(), 'items', '') ;?></em></li>
                            <?php } ?>
                            </ul>
                        </div>
                        <?php } ?>
