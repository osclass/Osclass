...
<head>
	...
	<link href="<?php echo osc_themeResource('browser.css'); ?>" rel="stylesheet" type="text/css" />
...
<div class="headerOptions" >
	...
	<?php _e('and '); ?>
	<a  href="<?php echo WEB_PATH; ?>/user.php?action=profile"><?php _e('profile'); ?></a>.<br />
	<a  href="<?php echo WEB_PATH; ?>/user.php?action=logout"><?php _e('Logout'); ?></a>
	<?php else: ?>
	<a  href="<?php echo WEB_PATH; ?>/user.php?action=register"><?php _e('Register a free account'); ?></a> <?php _e('or'); ?> <a  href="<?php echo WEB_PATH; ?>/user.php?action=login"><?php _e('login'); ?></a>
	<?php endif; ?>
</div>
