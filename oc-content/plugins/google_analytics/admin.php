...
<form action="<?php osc_admin_base_url(true); ?>" method="get">
    ...
    <div>
        <?php _e('Please enter your Google Analytics', 'google_analytics'); ?> <label for="webid" style="font-weight: bold;"><?php _e('Web property ID', 'google_analytics'); ?></label>: <input type="text" name="webid" id="webid" value="<?php echo osc_esc_html( $webid ); ?>" /> <input type="submit" value="<?php echo osc_esc_html( __('Save', 'google_analytics')); ?>" />
    </div>
</form>