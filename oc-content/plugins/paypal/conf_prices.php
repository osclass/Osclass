        ...
        <div style="float: left; width: 100%;">
            <fieldset>
                ...
                <div style="float: left; width: 100%;">
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <?php foreach($categories as $c) {?>
                            <tr>
                                ...
                                <td><input style="width:150px;text-align:right;" type="text" name="pub_prices[<?php echo $c['pk_i_id']?>]" id="pub_prices[<?php echo $c['pk_i_id']?>]" value="<?php echo isset($cat_prices[$c['pk_i_id']])?$cat_prices[$c['pk_i_id']]['f_publish_cost']:osc_get_preference("default_publish_cost", "paypal"); ?>" /></td>
                                <td><input style="width:150px;text-align:right;" type="text" name="pr_prices[<?php echo $c['pk_i_id']?>]" id="pr_prices[<?php echo $c['pk_i_id']?>]" value="<?php echo isset($cat_prices[$c['pk_i_id']])?$cat_prices[$c['pk_i_id']]['f_premium_cost']:osc_get_preference("default_premium_cost", "paypal"); ?>" /></td>
                            </tr>
                            <?php foreach($c['categories'] as $cc) {?>
                                <tr>
                                    <td>&nbsp;&nbsp;<?php echo $cc['s_name']; ?></td>
                                    <td><input style="width:150px;text-align:right;" type="text" name="pub_prices[<?php echo $cc['pk_i_id']?>]" id="pub_prices[<?php echo $cc['pk_i_id']?>]" value="<?php echo isset($cat_prices[$cc['pk_i_id']])?$cat_prices[$cc['pk_i_id']]['f_publish_cost']:'0'; ?>" /></td>
                    ...
                    <br/>
                    <button type="submit" style="float: right;"><?php echo  __('Update', 'paypal');?></button>
