<?php
    ...
    if(osc_get_preference('pay_per_post', 'paypal')) {
        ...
        if($item) {
            ...
            if(!$paid || (isset($paid) && $paid['b_paid']==0)) {
                ...
                <div>
                    ...
                    <div style="float:left; width: 50%;">
                        ...
                        <?php paypal_button($category_fee, sprintf(__("Publish fee for item %d at %s", "paypal"), $item['pk_i_id'], osc_page_title()), $item['fk_i_user_id']."|".$item['pk_i_id']."|".$item['s_contact_email'], "101x".$item['fk_i_category_id']); ?>
                    </div>
                ...
                <?php
                    ...
                    <br/>
                    <div><p><?php _e("There's no need to pay the publish fee", "paypal");?></p></div>
                    <?php
                }
            } else {
                ...
                <h1><?php _e("There was an error", "paypal");?></h1>
                <br/>
                <div><p><?php _e("The publish fee is already paid", "paypal");?></p></div>
                <?php
            }
        } else {
            ...
            <h1><?php _e("There was an error", "paypal");?></h1>
            <br/>
            <div><p><?php _e("The item doesn not exists", "paypal");?></p></div>
            <?php
        }
    } else {
