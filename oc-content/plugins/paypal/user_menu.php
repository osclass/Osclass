                ...
                <div id="main">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="item">
                            ...
                            <p>
                                <?php _e('Publication date', 'paypal') ; ?>: <?php echo osc_format_date(osc_item_pub_date()) ; ?>
                            </p>
                            <p>
                            ...
                            <p class="options">
                                ...
                                <?php } else { ?>
                                <strong>
                                    <a href="<?php echo osc_render_file_url(osc_plugin_folder(__FILE__) . 'payperpublish.php&itemId=' . osc_item_id()); ?>"><?php _e('Pay for this item', 'paypal'); ?></a>
                                </strong>
                                <?php } ?>
                                <span>|</span>
                                <?php if(paypal_is_premium(osc_item_id())) { ?>
                                <strong>
                                    <?php _e('Already premium!', 'paypal'); ?>
                                </strong>
                                <?php } else { ?>
                                <strong>
                                    <a href="<?php echo osc_render_file_url(osc_plugin_folder(__FILE__) . 'makepremium.php&itemId=' . osc_item_id()); ?>"><?php _e('Make premium', 'paypal'); ?></a>
                                </strong>
                                <?php } ?>
                            </p>
                        </div>
