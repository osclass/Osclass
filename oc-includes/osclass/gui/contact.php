                ...
                <div class="inner">
                    ...
                    <form action="<?php echo osc_base_url(true) ; ?>" method="post" onSubmit="javascript:return checkForm();">
                        ...
                        <fieldset>
                            ...
                            <label for="your_name"><?php _e('Your name', 'modern') ; ?> <?php _e('(optional)'); ?></label> <?php ContactForm::your_name() ; ?><br />
                            <label for="your_email"><?php _e('Your e-mail address', 'modern') ; ?></label> <?php ContactForm::your_email(); ?><br />
