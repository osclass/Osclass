...
<div class="content item">
    <div id="item_head">
        <div class="inner">
            <h1><span class="price"><?php echo osc_formatPrice($item); ?></span> <strong><?php echo $item['s_title']; ?></strong></h1>
    ...
    <div id="sidebar">
        <div id="photos">
            <?php if(count($resources)): ?>
				<?php foreach($resources as $r): ?>
					<img src="<?php echo WEB_PATH; ?>/oc-content/uploads/<?php echo $r['pk_i_id']; ?>.png" />
				<?php endforeach; ?>
			<?php endif; ?>
			<!--
        ...
        <div id="contact">
            ...
            <fieldset>
                ...
                <p class="phone">Tel.: (+34) 674 145 968</p>
