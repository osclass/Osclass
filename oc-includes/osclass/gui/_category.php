...
<div>
<span class="categoryHeader" ><?php echo $category['s_name']; ?></span> <a href="<?php echo osc_item_post_url($category); ?>" class="categoryLink" ><?php _e('Publish your item'); ?></a>
</div>

<div class="categoryList">
<?php foreach($subCats as $cat): ?>
	<a title="<?php echo $cat['s_description']; ?>" style="padding-right: 10px;" href="<?php osc_search_category_url($cat, true); ?>"><?php echo $cat['s_name']; ?></a>
<?php endforeach; ?>
</div>
