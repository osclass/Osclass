...
INSERT INTO /*TABLE_PREFIX*/t_preference VALUES
    ...
    ,('osclass', 'rewrite_item_url', 'item/{ITEM_ID}/{ITEM_TITLE}', 'STRING')
    ,('osclass', 'rewrite_page_url', 'page/{PAGE_SLUG}', 'STRING')
    ...
    ,('osclass', 'rewrite_user_activate_alert', 'user/activate/alert', 'STRING')
    ...
    ,('osclass', 'rewrite_user_change_password', 'user/change/password', 'STRING')
    ,('osclass', 'rewrite_user_change_email', 'user/change/email', 'STRING')
    ,('osclass', 'rewrite_user_change_email_confirm', 'user/change/email/confirm', 'STRING')
    ...
    ,('osclass', 'marketURL', 'http://market.osclass.org/oc-content/universe/universe.php?code=', 'STRING')
