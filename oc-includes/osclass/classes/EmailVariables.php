    ...
    class EmailVariables
    {
        ...
        public function init()
        {
            $this->variables = array(
                ...
                '{VALIDATION_LINK}' => sprintf(__('Link for account validation. ex: %s'),'<a target="_blank" href="'.osc_base_url().'">'.osc_base_url().'</a>'),
                '{VALIDATION_URL}'  => sprintf(__('Url for account validation. ex: %s'),osc_base_url()),
                '{ADS}'             => __('List of listings, used when send alerts'),
                '{UNSUB_LINK}'      => sprintf(__('Unsubscribe link. ex: %s'),'<a target="_blank" href="'.osc_base_url().'">'.osc_base_url().'</a>'),
                '{WEB_URL}'         => sprintf(__('Site home page url. ex: %s'),osc_base_url()),
                '{WEB_LINK}'        => sprintf(__('Site home page link. ex: %s'),'<a target="_blank" href="'.osc_base_url().'">'.osc_base_url().'</a>'),
