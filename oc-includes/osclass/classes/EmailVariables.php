    ...
    class EmailVariables
    {
        ...
        public function init()
        {
            $this->variables = array(
                ...
                '{VALIDATION_LINK}' => __('Link for account validation. ex: ').'<a target="_blank" href="'.osc_base_url().'">'.osc_base_url().'</a>',
                '{VALIDATION_URL}'  => __('Url for account validation. ex: ').osc_base_url(),
                '{ADS}'             => __('List of listings, used when send alerts'),
                '{UNSUB_LINK}'      => __('Unsubscribe link. ex: ').'<a target="_blank" href="'.osc_base_url().'">'.osc_base_url().'</a>',
                '{WEB_URL}'         => __('Site home page url. ex: ').osc_base_url(),
                '{WEB_LINK}'        => __('Site home page link. ex: ').'<a target="_blank" href="'.osc_base_url().'">'.osc_base_url().'</a>',
