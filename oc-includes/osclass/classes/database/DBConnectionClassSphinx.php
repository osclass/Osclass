...
class DBConnectionClassSphnix
{
	 ...
	 * @param bool $sphinx Use SphinxSE
	 * @return DBConnectionClass 
	 */
	public static function newInstance($server = '', $user = '', $password = '', $database = '')
	{

			$server      = ($server == '') ? osc_sphinx_db_host() : $server ;
			$user        = ($user == '') ? osc_sphinx_db_user() : $user ;
			$password    = ($password == '') ? osc_sphinx_db_password() : $password ;
			$database    = ($database == '') ? osc_sphinx_db_name() : $database ;
	 ...
	 * @param string $password MySQL password
	 */
	public function __construct($server, $user, $password, $database, $sphinx = false)
	{
		$this->dbHost       = $server ;
		$this->dbName       = $database ;
		$this->dbUser       = $user ;
		$this->dbPassword   = $password ;
		$this->useSphinx	= $sphinx;
