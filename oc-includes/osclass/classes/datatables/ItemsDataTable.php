        ...
        private function processData($items)
        {
            if(!empty($items)) {
                ...
                foreach($items as $aRow) {
                    ...
                    $row['expiration'] = ($aRow['dt_expiration'] != '9999-12-31 23:59:59') ? osc_format_date($aRow['dt_pub_date'], osc_date_format() . ' ' . osc_time_format() ) : __('<span style="color:#F00;">') . __('Never expires') . __('</span>');
