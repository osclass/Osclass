...
class Category extends DAO {
    ...
    public function toTreeAll() {
        ...
        foreach ($roots as &$r) {
            $r['categories'] = $this->toSubTreeAll($r['pk_i_id']);//$this->listWhere("a.fk_i_parent_id = " . $r['pk_i_id'] . "");
        }
        unset($r);
        return $roots;
    }
