 ...
 */
    ...
    // Class: BaseDAO_osclass_t_item_description
    // Table: t_item_description
    // Database: osclass

    abstract class BaseDAO_osclass_t_item_description extends DAO
    {
        /* Attributes */
        var $DO ;
        var $aDO ;
        ...
        // Method that selects a row of "t_item_description" using the PK
        function selectBy_pk($fk_i_item_id, $fk_c_locale_code, $aCampos="", $where="")
        {
            ...
            $sql .= "FROM " . $this->get_table_name('t_item_description') . " " ;
        ...
        //Method that selects a row of "t_item_description" using "fk_i_item_id"
        ...
        //Method that selects a row of "t_item_description" using "fk_c_locale_code"
        ...
        // Method that selects all the rows of "t_item_description" that satisfies the WHERE conditions
        ...
        // Method that return the total of the rows of "t_item_description" that satisfies the WHERE conditions
        ...
        function insert($DO)
        {
            ...
            if (is_array($this->noDuplicateFields) || is_array($this->noDuplicateUniqueKey))
            {
                ...
                $can_insert = true ;
                if ($where_select != "") {
                    $sql = "SELECT * FROM " . $this->get_table_name('t_item_description') . " WHERE " . $where_select ;
            ...
            if ($can_insert)
            {
                $sql  = "INSERT INTO " . $this->get_table_name('t_item_description') . " SET " ;
                ...
                {
                    if ($cond != "") $cond .= ", " ;
                       $cond .= "s_what = '" . addslashes($DO["s_what"]) . "'" ;
                }
                $sql .= $cond ;
		...
		function multiple_inserts($mDO) {
            ...
            $sql  = "INSERT INTO " . $this->get_table_name('t_item_description') . " (fk_i_item_id,fk_c_locale_code,s_title,s_description,s_what) VALUES " ;
            $cond = "" ;$primera = true;
        ...
        function updateBy_pk($DO, $where="")
        {
            ...
            if (is_array($this->noDuplicateFields) || is_array($this->noDuplicateUniqueKey))
            {
                ...
                if ($where_select != "") {
                    $sql = "SELECT * FROM " . $this->get_table_name('t_item_description') . " WHERE (" . $where_select . ") AND NOT (fk_i_item_id = '" . addslashes($DO["fk_i_item_id"]) . "' AND fk_c_locale_code = '" . addslashes($DO["fk_c_locale_code"]) . "')";
            ...
            if ($can_update)
            {
                $sql  = "UPDATE " . $this->get_table_name('t_item_description') . " SET " ;
