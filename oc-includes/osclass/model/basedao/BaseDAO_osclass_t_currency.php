 ...
 */
    ...
    // Class: BaseDAO_osclass_t_currency
    // Table: t_currency
    // Database: osclass

    abstract class BaseDAO_osclass_t_currency extends DAO
    {
        /* Attributes */
        var $DO ;
        var $aDO ;
        ...
        // Method that selects a row of "t_currency" using the PK
        function selectBy_pk($pk_c_code, $aCampos="", $where="")
        {
            ...
            $sql .= "FROM " . $this->get_table_name('t_currency') . " " ;
        ...
        // Method that selects all the rows of "t_currency" that satisfies the WHERE conditions
        ...
        // Method that return the total of the rows of "t_currency" that satisfies the WHERE conditions
        ...
        function insert($DO)
        {
            ...
            if (is_array($this->noDuplicateFields) || is_array($this->noDuplicateUniqueKey))
            {
                ...
                $can_insert = true ;
                if ($where_select != "") {
                    $sql = "SELECT * FROM " . $this->get_table_name('t_currency') . " WHERE " . $where_select ;
            ...
            if ($can_insert)
            {
                $sql  = "INSERT INTO " . $this->get_table_name('t_currency') . " SET " ;
		...
		function multiple_inserts($mDO) {
            ...
            $sql  = "INSERT INTO " . $this->get_table_name('t_currency') . " (pk_c_code,s_name,s_description,b_enabled) VALUES " ;
            $cond = "" ;$primera = true;
        ...
        function updateBy_pk($DO, $where="")
        {
            ...
            if (is_array($this->noDuplicateFields) || is_array($this->noDuplicateUniqueKey))
            {
                ...
                if ($where_select != "") {
                    $sql = "SELECT * FROM " . $this->get_table_name('t_currency') . " WHERE (" . $where_select . ") AND NOT (pk_c_code = '" . addslashes($DO["pk_c_code"]) . "')";
            ...
            if ($can_update)
            {
                $sql  = "UPDATE " . $this->get_table_name('t_currency') . " SET " ;
