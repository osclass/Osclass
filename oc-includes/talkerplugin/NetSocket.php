<?php
/*
 * This class has been modified from PEAR's Net_Socket class (http://pear.php.net/Net_Socket)
 * to remove the dependency on PEAR. The changes mostly involved changing all occurrences 
 * of "return $this->raiseError(...)" to * "throw new Exception(...)". Now this is a 
...
class NetSocket {
    ...
    function enableCrypto($enabled, $type)
    {
        if (version_compare(phpversion(), "5.1.0", ">=")) {
            ...
            throw new Exception('Net_Socket::enableCrypto() requires php version >= 5.1.0');
        }
    }
