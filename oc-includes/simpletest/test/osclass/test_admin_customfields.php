...
class TestOfAdminCustomFields extends WebTestCase {
    ...
    private function customOnFrontEnd()
    {
        ...
        $this->assertTrue($this->selenium->isTextPresent("sameField field is required.","(no logged) can add items with customs fields required. ERROR") );
        ...
        $this->assertTrue($this->selenium->isTextPresent("Your item has been published","(no logged) error inserting ad with customs fields. ERROR") );
    ...
    private function customOnAdminPanel()
    {
        ...
        $this->assertTrue($this->selenium->isTextPresent("A new item has been added"),"(no logged) error inserting ad with customs fields. ERROR" );
    }
