     ...
     class ItemsProcessingAjax
     {
        ...
        private function toArrayFormat() {
            ...
            foreach ($this->items as $aRow)
            {
                ...
                $options_more = array();
                if( $aRow['b_active'] ) {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=INACTIVE">' . __('Deactivate') .'</a>';
                } else {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=ACTIVE">' . __('Activate') .'</a>';
                }
                if( $aRow['b_enabled'] ) {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=DISABLE">' . __('Block') .'</a>';
                } else {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=ENABLE">' . __('Unblock') .'</a>';
                }
                if( $aRow['b_premium'] ) {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status_premium&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=0">' . __('Unmark as premium') .'</a>';
                } else {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status_premium&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=1">' . __('Mark as premium') .'</a>';
                }
                if( $aRow['b_spam'] ) {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status_spam&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=0">' . __('Unmark as spam') .'</a>';
                } else {
                    $options_more[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=status_spam&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;value=1">' . __('Mark as spam') .'</a>';
                }
        ...
        private function toArrayFormatReported() {
            ...
            foreach ($this->items as $aRow)
            {
                ...
                $options[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;stat=all">' . __('Clear All') .'</a>';
                if( $aRow['i_num_spam'] > 0 ) {
                    $options[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;stat=spam">' . __('Clear Spam') .'</a>';
                }
                if( $aRow['i_num_bad_classified'] > 0 ) {
                    $options[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;stat=bad">' . __('Clear Misclassified') .'</a>';
                }
                if( $aRow['i_num_repeated'] > 0 ) {
                    $options[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;stat=duplicated">' . __('Clear Duplicated') .'</a>';
                }
                if( $aRow['i_num_offensive'] > 0 ) {
                    $options[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;stat=offensive">' . __('Clear Offensive') .'</a>';
                }
                if( $aRow['i_num_expired'] > 0 ) {
                    $options[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=clear_stat&amp;id=' . $aRow['pk_i_id'].'&amp;'.$token_url . '&amp;stat=expired">' . __('Clear Expired') .'</a>';
                }
                if(count($options) > 0) {
                    $options[] = '<a href="' . osc_admin_base_url(true) . '?page=items&amp;action=item_edit&amp;id=' . $aRow['pk_i_id'] . '">' . __('Edit') . '</a>';
                    $options[] = '<a onclick="return delete_dialog(\'' . $aRow['pk_i_id'] . '\');" href="' . osc_admin_base_url(true) . '?page=items&amp;action=delete&amp;id[]=' . $aRow['pk_i_id'] . '">' . __('Delete') . '</a>';
