...
<div style="position:relative;">
    <div id="listing-toolbar">
        <div class="float-right">
            ...
            </select><input type="text" name="sPatter" class="input-text input-actions input-has-select"/><input type="submit" class="btn submit-right"/ value="<?php echo osc_esc_html( __('Find') ) ; ?>">
        </div>
    </div>
