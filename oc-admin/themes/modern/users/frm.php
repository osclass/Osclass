				...
				<div id="settings_form" style="border: 1px solid #ccc; background: #eee; ">
					<div style="padding: 20px;">
						...
						<div style="float: left; width: 50%;">
							...
							<fieldset>	
								<legend><?php echo __('Retype the password'); ?> </legend>						
						...
						<div style="float: left; width: 50%;">
							<fieldset>	
								<legend><?php echo __('Country'); ?></legend>	
								<?php UserForm::country_select($countries, $user); ?>
							</fieldset>
							
							<fieldset>	
								<legend><?php echo __('Region'); ?></legend>	
								<?php UserForm::region_select($regions, $user); ?>
							</fieldset>
							
							<fieldset>	
								<legend><?php echo __('City'); ?></legend>	
								<?php UserForm::city_select($cities, $user); ?>
							</fieldset>
							
							<fieldset>
								<legend><?php echo __('City Area'); ?></legend>
