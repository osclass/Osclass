		...
		<div id="content">
		    ...
		    <div id="right_column">
				<div id="content_header" class="content_header">
					...
					<div id="content_header_arrow">&raquo; <?php echo __('Edit user'); ?></div> 
				...
				<div id="settings_form" style="border: 1px solid #ccc; background: #eee; ">
					<div style="padding: 20px;">
						...
						<input type="hidden" name="id" value="<?php echo $user['pk_i_id']; ?>" />
						
						<div style="float: left; width: 50%;">
							<fieldset>	
								<legend><?php echo __('User name'); ?> (<?php echo __('required'); ?>)</legend>						
								<input type="text" name="s_username" id="s_username" value="<?php echo $user['s_username']; ?>" />
							</fieldset>
						</div>
						...
						<div style="float: left; width: 50%;">
							<fieldset>	
								...
								<input type="text" name="s_email" id="s_email" value="<?php echo $user['s_email']; ?>" />
							</fieldset>
						</div>
						...
						<div style="float: left; width: 50%;">
							<fieldset>	
								...
								<input type="text" name="s_website" id="s_website" value="<?php echo $user['s_website']; ?>" />
							</fieldset>
						</div>
						<div style="clear: both;"></div>
						...
						<div style="float: left; width: 50%;">
							<fieldset>	
								...
								<input type="text" name="s_name" id="name" value="<?php echo $user['s_name']; ?>" />
							</fieldset>
							
							<fieldset>
								<legend><?php echo __('Mobile phone'); ?></legend>
								<input type="text" name="s_phone_mobile" id="s_phone_mobile" value="<?php echo $user['s_phone_mobile']; ?>" />
							</fieldset>
							
							<fieldset>
								<legend><?php echo __('Land phone'); ?></legend>
								<input type="text" name="s_phone_land" id="s_phone_land" value="<?php echo $user['s_phone_land']; ?>" />
							</fieldset>
						</div>
