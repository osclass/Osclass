...
<div class="left" id="left-side">
    ...
    <li id="menu_items" class="<?php echo $menuActive['items']; ?>">
        <h3><a id="items" href="#"><?php _e('Listing') ; ?></a></h3>
        <ul>
            <li><a id="items_manage" href="<?php echo osc_admin_base_url(true) ; ?>?page=items"><?php _e('Manage Listings') ; ?></a></li>
            ...
            <li><a id="items_cfields" href="<?php echo osc_admin_base_url(true) ; ?>?page=cfields"><?php _e('Manage custom fields') ; ?></a></li>
...
<!--    <li id="menu_customfields" class="<?php echo $menuActive['customfields']; ?>">
    ...
    <li id="menu_settings" class="<?php echo $menuActive['settings']; ?>">
        ...
        <ul>
            ...
            <li><a id="settings_emails_manage" href="<?php echo osc_admin_base_url(true) ; ?>?page=emails"><?php _e('E-mail templates') ; ?></a></li>
            <li><a id="settings_language_manage" href="<?php echo osc_admin_base_url(true) ; ?>?page=languages"><?php _e('Manage languages') ; ?></a></li>
            <li><a id="settings_language_new" href="<?php echo osc_admin_base_url(true) ; ?>?page=languages&action=add"><?php _e('Add a language') ; ?></a></li>
    ...
    <li id="menu_users" class="<?php echo $menuActive['users']; ?>">
        ...
        <ul>
            <li><a id="users_administrators_manage" href="<?php echo osc_admin_base_url(true) ; ?>?page=admins"><?php _e('Manage administrators') ; ?></a></li>
            <li><a id="users_administrators_new" href="<?php echo osc_admin_base_url(true) ; ?>?page=admins&action=add"><?php _e('Add new administrator') ; ?></a></li>
            <li><a id="users_manage" href="<?php echo osc_admin_base_url(true); ?>?page=users"><?php _e('Manage users') ; ?></a></li>
            <li><a id="users_new" href="<?php echo osc_admin_base_url(true); ?>?page=users&action=create"><?php _e('Add new user') ; ?></a></li>
            <li><a id="users_settings" href="<?php echo osc_admin_base_url(true); ?>?page=users&action=settings"><?php _e('User settings') ; ?></a></li>
            <li><a id="users_administrators_profile" href="<?php echo osc_admin_base_url(true) ; ?>?page=admins&action=edit"><?php _e('Your Profile') ; ?></a></li>
        </ul>
    </li>
    ...
    <li id="menu_stats" class="<?php echo $menuActive['stats']; ?>">
        ...
        <ul>
            ...
            <li><a id="stats_items" href="<?php echo osc_admin_base_url(true) ; ?>?page=stats&action=items"><?php _e('Listings') ; ?></a></li>
