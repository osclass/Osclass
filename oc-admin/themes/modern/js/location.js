    ...
    function show_region(c_code, s_country) {
        $.ajax({
            "url": base_url + "oc-includes/osclass/ajax/region.php?countryId=" + c_code,
            "dataType": 'json',
            success: function( json ) {
                ...
                $.each(json, function(i, val){
                    ...
                    s_country.append('<a class="close" href="' + base_url + 'oc-admin/index.php?page=settings&action=locations&type=delete_region&id=' + val.pk_i_id + '"><img src="' + base_url + 'oc-admin/images/close.png" alt="' + s_close + '" title="' + s_close + '" /></a>');
    ...
    function show_city(id_region) {
        $.ajax({
            "url": base_url + "oc-includes/osclass/ajax/city.php?regionId=" + id_region,
            "dataType": 'json',
            success: function( json ) {
                ...
                $.each(json, function(i, val){
                    ...
                    s_region.append('<a class="close" href="' + base_url + 'oc-admin/index.php?page=settings&action=locations&type=delete_city&id=' + val.pk_i_id + '"><img src="' + base_url + 'oc-admin/images/close.png" alt="' + s_close + '" title="' + s_close + '" /></a>');
