                    ...
                    ,"aaData": [
                        <?php foreach(__get('comments') as $c) { ?>
                            [
                                ...
                                ,"<?php echo addcslashes($c['s_author_name'],'"'); ?> (<a target='_blank' href='<?php echo osc_item_url_ns( $c['fk_i_item_id'] ) ; ?>'><?php echo addslashes($c['s_title']); ?></a>)<div id='datatables_quick_edit'><a href='<?php echo osc_admin_base_url(true) ; ?>?page=comments&action=comment_edit&id=<?php echo $c['pk_i_id'] ; ?>' id='dt_link_edit'><?php _e('Edit'); ?></a><?php
