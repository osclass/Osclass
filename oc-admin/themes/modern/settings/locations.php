                    ...
                    <div style="float:left; width: 33%;  margin-left:10px">
                        ...
                        <div id="l_countries" style="padding: 10px 0;">
                            ...
                            <div style="padding: 4px; width: 90%;">
                                <div style="float:left;">
                                    <div>
                                        <a id="country_delete" class="close" onclick="javascript:return confirm('<?php echo osc_esc_js(__('This action can not be undone. Items with this location associated will be deleted. Are you sure you want to continue?','modern')); ?>');" href="<?php echo osc_admin_base_url(true); ?>?page=settings&action=locations&type=delete_country&id=<?php echo urlencode($country['pk_c_code']) ; ?>">
