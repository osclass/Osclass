                ...
                <form action="settings.php" method="post">
                    ...
                    <div style="float: left; width: 50%;">
                        <fieldset>
                                ...
                                <?php } ?>
                                <label for="df_custom"><?php _e('Custom'); ?>:</label> <input type="text" name="dateFormat" id="dateFormat" value="<?php echo $preferences['dateFormat']; ?>" />
                                </div>
                        </fieldset>
                    </div>
                    ...
                    <div style="float: left; width: 50%;">
                        ...
                        <fieldset>
                            ...
                            <select name="weekStart" id="weekStart">
                                ...
                                <option value="1" <?php if(isset($preferences["weekStart"]) && $preferences["weekStart"] == '1') { ?>selected="selected"<?php } ?>><?php _e('Monday'); ?></option>
                                <option value="2" <?php if(isset($preferences["weekStart"]) && $preferences["weekStart"] == '2') { ?>selected="selected"<?php } ?>><?php _e('Tuesday'); ?></option>
                                <option value="3" <?php if(isset($preferences["weekStart"]) && $preferences["weekStart"] == '3') { ?>selected="selected"<?php } ?>><?php _e('Wednesday'); ?></option>
                                <option value="4" <?php if(isset($preferences["weekStart"]) && $preferences["weekStart"] == '4') { ?>selected="selected"<?php } ?>><?php _e('Thursday'); ?></option>
                                <option value="5" <?php if(isset($preferences["weekStart"]) && $preferences["weekStart"] == '5') { ?>selected="selected"<?php } ?>><?php _e('Friday'); ?></option>
                                <option value="6" <?php if(isset($preferences["weekStart"]) && $preferences["weekStart"] == '6') { ?>selected="selected"<?php } ?>><?php _e('Saturday'); ?></option>
                            </select>
                        </fieldset>
                    </div>
                    ...
                    <div style="float: left; width: 50%;">
                        <fieldset>
                                ...
                                <?php endif; ?>
                                <label for="tf_custom"><?php _e('Custom'); ?>:</label> <input type="text" name="timeFormat" id="timeFormat" value="<?php echo $preferences['timeFormat']; ?>" />
                                </div>
                        </fieldset>
                    </div>
