<?php
    ...
    while( osc_has_static_pages() ) {
        ...
        if( !$page['b_indelible'] ) {
            $options[] = '<a onclick="javascript:return confirm(\'' . osc_esc_js(__("This action can't be undone. Are you sure you want to continue?","modern")) . '\')" href="' . osc_admin_base_url(true) . '?page=pages&amp;action=delete&amp;id=' . osc_static_page_id() . '">' . __('Delete') . '</a>' ;
        }
