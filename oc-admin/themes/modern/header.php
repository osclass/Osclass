...
<div id="static"> <a style="text-decoration:none;" target="_blank" href="http://admin.osclass.org/feedback.php"><img style="border:0px;" alt="Feedback" src="<?php echo  osc_current_admin_theme_url() ; ?>images/feedback_button_new.gif"></a> </div>